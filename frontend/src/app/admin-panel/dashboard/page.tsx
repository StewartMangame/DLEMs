    ...
    <div className={styles.page}>
      ...
      <section className={styles.section}>
        ...
        <div className={styles.quickLinks}>
          {[
            { href: "/admin-panel/institutions", label: "Manage Institutions", icon: "🏛" },
            { href: "/admin-panel/saccos", label: "Manage SACCOs", icon: "🤝" },
            { href: "/admin-panel/users", label: "View Users", icon: "👥" },
            { href: "/admin-panel/content?status=placeholder", label: "Translate Strings", icon: "🌐" },
            { href: "/admin-panel/announcements", label: "Announcements", icon: "📢" },
            { href: "/admin-panel/activity-log", label: "Activity Log", icon: "📋" },
          ].map(link => (
