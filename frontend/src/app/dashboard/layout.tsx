...
const NAV_ITEMS = [
  ...
  { href: "/dashboard/institutions", icon: Building2, key: "nav.institutions" },
  { href: "/dashboard/eligibility", icon: Scale, key: "nav.compare" },
  { href: "/dashboard/loans", icon: Wallet, key: "nav.loans" },
];
